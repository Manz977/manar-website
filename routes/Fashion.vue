...
<template>
  ...
  <h1 class="h1-fashion">Fashion & Beauty</h1>
  <div class="gallery">
...
/>
  ...
  <!-- add more .gallery-item elements as desired -->
</div>
...
.h1-fashion {
  font-size: 4rem;
  margin: 6rem  0 7rem 1.5rem;
}

/* Tablet / iPad portrait: 2 columns */
...
/* Desktop: 4 columns + masonry effect */
